...
ManageUsers() {
    ...
    l3.setBounds(50, 155, 100, 30);
    l4.setBounds(50, 205, 100, 30);
    l5.setBounds(520, 20, 200, 30);

    t1.setBounds(150, 55, 170, 30);
    passwordField.setBounds(150, 105, 170, 30);
    t3.setBounds(150, 155, 170, 30);
    t4.setBounds(150, 205, 170, 30);
	...
	DefaultTableModel model = new DefaultTableModel();
        ...
        scrollPane.setBounds(380, 55, 380, 260);
        c.add(scrollPane);
