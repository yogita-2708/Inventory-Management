...
class ManageProduct extends JFrame implements ActionListener {
    ...
    ManageProduct() {
        ...
        scrollPane.setBounds(320, 55, 550, 320);
        c.add(scrollPane);
		...
		if (e.getSource() == b1) {
            ...
            try {
                ...
                Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "SYSDBA",
                        "sys2708");
                String sql = "INSERT INTO PRODUCT VALUES(" + pid + ",'" + n + "','" + q + "','" + des + "'," + pr + ",'"+cat+"')";
                Statement st = con.createStatement();
                ...
                try{
                   //update data in the table model
                    ...
                    if(rowIndex != -1)
                    {
                        ...
                        Class.forName("oracle.jdbc.driver.OracleDriver");
                        Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "SYSDBA", "sys2708");
                        String sql = "UPDATE Product SET PNAME = '" + n + "', QUANTITY = '" + q + "', DESCRIPTION = '" + des + "', PRICE = " + pr + " WHERE PID =" + pid;
